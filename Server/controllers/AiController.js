...
class AiController {
  static async nameMyJob(req, res, next) {
    try {
      ...
      const prompt = `Please give me 6 job recommendations based on age ${profile.age}, skill ${profile.skill}. Please give me only the data in an array of objects without any further explanation and without JSON code blocks and without any backticks.`;
